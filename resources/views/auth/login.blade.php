...
<html lang="en">
    <head>
		...
		<link href="/assets/css/bootstrap-dark.min.css" rel="stylesheet" type="text/css" id="bs-bright-stylesheet" />
                                ...
                                <div class="text-center w-75 m-auto">
                                    <div class="auth-logo">
                                        <a href="#" class="logo logo-dark text-center">
                                            <h1 class="logo-lg">
                                              <h3>PENDATAAN MAHASISWA LANNI JAYA</H3>
                                            </h1>
                                        </a>

                                        <a href="#" class="logo logo-light text-center">
                                            <h1 class="logo-lg">
                                                SI Pendataan Mahasiswa Aslan
                                            </h1>
                                        </a>
                                    </div>
